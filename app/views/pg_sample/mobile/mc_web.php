...
$MC_SVCID	= "";		//[  12byte 고정] 모빌리언스에서 부여한 서비스ID (12byte 숫자 형식)
$Prdtprice	= "";		//[  10byte 이하] 결제요청금액 (암호화 사용 시 암호화 대상)
...
$Prdtnm		= "";		//[  50byte 이하] 상품명
$Siteurl	= "";		//[  20byte 이하] 가맹점도메인 (예: www.mcash.co.kr)
